...
def evolve() -> dict:
    ...
    def w(genome):
        wr = play_n_games(GA_Player, RandomPlayer.RandomPlayer, genome)
        return wr
    ...
    logging.info(f"Best genome found (avg of fitness) is {best_individuals[0][0]} with avg fitness: {best_individuals[0][1]}")
